...
You can install RoboStack packages using either [Pixi](https://pixi.sh/), [Micromamba](/micromamba.html), or [conda](/conda.html).
...
:::caution[Do not source to existing `apt` installed ROS environments]
...
<details>
<summary>What did just happen?</summary>
